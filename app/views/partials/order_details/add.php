                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="masakan_id">Masakan Id <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-masakan_id"  value="<?php  echo $this->set_field_value('masakan_id',""); ?>" type="number" placeholder="Enter Masakan Id" step="1"  required="" name="masakan_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

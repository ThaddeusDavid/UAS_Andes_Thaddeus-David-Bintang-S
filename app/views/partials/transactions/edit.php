                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-total_harga"  value="<?php  echo $data['total_harga']; ?>" type="number" placeholder="Enter Total Harga" step="0.1"  required="" name="total_harga"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

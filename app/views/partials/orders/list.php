                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-meja_id">
                                                        <span  data-value="<?php echo $data['meja_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="meja_id" 
                                                            data-title="Enter Meja Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" >
                                                            <?php echo $data['meja_id']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-total_price">
                                                        <span  data-step="0.1" 
                                                            data-value="<?php echo $data['total_price']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-status_order">
                                                        <span  data-value="<?php echo $data['status_order']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("orders/editfield/" . urlencode($data['id'])); ?>" 

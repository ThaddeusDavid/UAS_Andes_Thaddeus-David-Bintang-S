                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="meja_id">Meja Id <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-meja_id"  value="<?php  echo $this->set_field_value('meja_id',""); ?>" type="number" placeholder="Enter Meja Id" step="1"  required="" name="meja_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-total_price"  value="<?php  echo $this->set_field_value('total_price',""); ?>" type="number" placeholder="Enter Total Price" step="0.1"  required="" name="total_price"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="status_order">Status Order <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-status_order"  value="<?php  echo $this->set_field_value('status_order',""); ?>" type="text" placeholder="Enter Status Order"  required="" name="status_order"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-level_id"  value="<?php  echo $this->set_field_value('level_id',""); ?>" type="number" placeholder="Enter Level Id" step="1"  required="" name="level_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-email_verified_at"  value="<?php  echo $this->set_field_value('email_verified_at',""); ?>" type="email" placeholder="Enter Email Verified At"  required="" name="email_verified_at"  data-url="api/json/users_email_verified_at_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                                <div class="check-status"></div> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="input-group">
                                                                                <div class="dropzone required" input="#ctrl-updated_at" fieldname="updated_at"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                                    <input name="updated_at" id="ctrl-updated_at" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('updated_at',""); ?>" type="text"  />

                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-level_id"  value="<?php  echo $data['level_id']; ?>" type="number" placeholder="Enter Level Id" step="1"  required="" name="level_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        <div class="dropzone required" input="#ctrl-updated_at" fieldname="updated_at"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                            <input name="updated_at" id="ctrl-updated_at" required="" class="dropzone-input form-control" value="<?php  echo $data['updated_at']; ?>" type="text"  />
                                                                        ...
                                                                        <?php Html :: uploaded_files_list($data['updated_at'], '#ctrl-updated_at'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
